...
public class CostumeAdapter extends BaseAdapter {
    ...
    public CostumeAdapter(Context applicationContext, ArrayList<String> cityList, ArrayList<String> symbols) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.custom_lv_request, null);
